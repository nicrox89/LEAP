...
class fitness():
    ...
    def f(self, chromosome):
        ...
        multi_contribution = self.chain_rule(ch, y, selected_partition, num_partition_features)
        ...
        #OF = multi_contribution_CMI + (-num_partition_features+1)
        #OF = c * math.exp(-num_partition_features)
        #OF = MI 
        #OF = multi_contribution_CMI/num_partition_features
        #OF = c - ((num_partition_features-1)/(num_genes-1))
    ...
    def multivariate_CMI(self, ch, y, selected_features_index, selected_partition, num_partition_features):
        ...
        # demonstration comparting with CHAIN RULE (X1,X2,X2;Y) no Z -----
